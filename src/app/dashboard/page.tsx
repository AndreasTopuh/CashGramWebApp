...
import { Plus, LogOut, Trash2, TrendingUp, Calendar, BarChart3, PieChart, Brain, MessageCircle, Download, ChevronLeft, ChevronRight, Wallet, Sparkles, Tag } from 'lucide-react'
...
export default function DashboardPage() {
  ...
  const expenseAmountValue = amount ? parseFormattedNumber(amount) || 0 : 0
  const selectedCategory = categoryId ? categories.find((category) => category.id === categoryId) || null : null
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {showAddForm && (
          <div className="fixed inset-0 z-50 flex items-start justify-center px-3 sm:px-6 py-6 sm:py-8 overflow-y-auto">
            <div
            ...
            <div className="relative z-10 bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-4xl max-h-[92vh] overflow-hidden flex flex-col my-6 sm:my-10">
              <div className="flex items-start justify-between gap-4 px-5 sm:px-8 pt-6 pb-4 border-b border-gray-100">
                <div>
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900">Catat Pengeluaran Baru</h3>
                  <p className="text-sm text-gray-500 mt-1">
                    Isi nominal, pilih kategori, dan tambahkan catatan bila perlu. Semua data akan langsung tersimpan.
                  </p>
                </div>
                <button
                  type="button"
              ...
              <form onSubmit={handleAddExpense} className="flex flex-col flex-1">
                  ...
                  <div className="grid gap-6 md:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
                    <section className="space-y-6">
                      <div>
                        ...
                        <div className="relative rounded-xl border border-gray-300 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-200 transition">
                          ...
                          <input
                            ...
                            placeholder="0"
                            className="w-full pl-12 pr-4 py-3 rounded-xl focus:outline-none text-lg font-semibold tracking-wide text-right text-gray-900"
                            inputMode="numeric"
                            required
                          />
                        </div>
                        <div className="flex flex-wrap items-center gap-2 mt-3">
                          ...
                          {quickAmounts.map((value) => (
                            <button
                              key={value}
                              type="button"
                              onClick={() => setAmount(formatNumber(value.toString()))}
                              className="px-3 py-1.5 rounded-full bg-blue-50 text-blue-600 text-xs font-semibold hover:bg-blue-100 transition"
                            >
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <select
                            ...
                            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm text-gray-900"
                            required
                          >
                        ...
                        {categories.length > 0 && (
                          <div>
                            <p className="text-xs text-gray-500 mb-2">Shortcut kategori favorit:</p>
                            <div className="flex flex-wrap gap-2">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          placeholder="Contoh: makan siang dengan teman atau bayar listrik bulan ini"
                          rows={3}
                          className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm text-gray-900 resize-none"
                        />
                        <p className="text-xs text-gray-400 mt-2">
                          Catatan membantu kamu mengingat detail transaksi ketika dianalisis oleh AI atau diekspor.
                        </p>
                      </div>
                    </section>
                    ...
                    <section className="space-y-4">
                      <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-4 sm:p-5">
                        <div className="flex items-start gap-3">
                          <div className="w-10 h-10 rounded-xl bg-white/80 flex items-center justify-center text-blue-500">
                            <Wallet size={20} />
                          </div>
                          <div className="flex-1">
                            <p className="text-sm font-semibold text-blue-700">Ringkasan Cepat</p>
                            <div className="mt-3 space-y-2 text-sm text-blue-900">
                              <div className="flex items-center justify-between">
                                <span className="text-blue-600">Nominal</span>
                                <span className="font-semibold">{expenseAmountValue > 0 ? formatCurrency(expenseAmountValue) : 'Belum diisi'}</span>
                              </div>
                              <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center justify-between">
                                <span className="text-blue-600">Catatan</span>
                                <span className="font-semibold flex items-center gap-1">
                                  <Tag size={14} className="text-blue-500" />
                                  {description ? description.slice(0, 18) + (description.length > 18 ? '…' : '') : 'Opsional'}
                                </span>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="rounded-2xl border border-gray-200 bg-white p-4 sm:p-5 space-y-3">
                        <h4 className="text-sm font-semibold text-gray-800">Tips Cepat</h4>
                        <ul className="list-disc list-inside text-xs text-gray-500 space-y-2">
                          <li>Gunakan format angka saja, sistem otomatis menambahkan Rp.</li>
                          <li>Catatan membantumu saat export Excel atau analisis AI.</li>
                          <li>Pilih kategori yang sama dengan di bot Telegram untuk sinkron data.</li>
                        </ul>
                      </div>
                    </section>
                  </div>
                ...
                <div className="px-5 sm:px-8 pb-6 pt-5 border-t border-gray-100 flex flex-col sm:flex-row gap-3">
                  <button
                    type="button"
                    onClick={() => !saving && setShowAddForm(false)}
                  ...
                  <button
                    type="submit"
                    disabled={saving}
                    className="sm:flex-1 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed text-sm font-semibold"
                  >
